...
```cmd copy
$OttoFMSInstallVersion = "4.1.0"; iex ((New-Object System.Net.WebClient).DownloadString('https://downloads.ottomatic.cloud/ottofms/install-scripts/install-win.ps1'))
```
