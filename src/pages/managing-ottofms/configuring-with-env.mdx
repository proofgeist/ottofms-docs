...
The File Manager in the OttoFMS console can be configured to send logs to the otto-info.log for access and changes to teh file system. to enable this logging set the following key:
