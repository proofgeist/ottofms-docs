...
The list view shows all the API Keys that have been configured for the databases on your server. You can add a new Key by clicking the "Create API Key" button in the top right corner. You can also edit or delete existing keys by clicking the "Edit" or "Trashcan" buttons on the right edge of the list.
