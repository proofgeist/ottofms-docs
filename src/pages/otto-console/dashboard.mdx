...
The statistics in the top right of the dashboard are based on existing data, if you delete any deployments from the deployments tab, those deletions will be reflected in these statistics.
...
Here is what it looks like in dark mode, with the theme set filled sidebar, and the 'proof+geist' pink brand color.
