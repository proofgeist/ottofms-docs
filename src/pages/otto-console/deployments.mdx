...
Each deployments has a details page which can show you the deployment logs, run time, and specific information on files the deployment worked with. You can access the deployments details page by clicking on the deployment name in the deployments list.
