...
If you are using sub-deploymentsm you will see a disclosure triangle in the deployment Id column. Clicking on this will show you the sub-deployments for that deployment.
