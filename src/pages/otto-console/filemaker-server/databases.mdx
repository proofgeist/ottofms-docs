...
Click the three dots on the right to see the options for the database. You can use the menu to **open**, **close**, **pause**, **resume**, **download**, **encrypt**, **decrypt**, **save as xml**, **rename**, **move**, **copy**, or **delete** the database file.
