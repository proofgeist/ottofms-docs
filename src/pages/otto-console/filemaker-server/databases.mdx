...
In OttoFMS version 4.4.0 and later, you can rename files by clicking the three dots on the right of the file and selecting "Rename". This will open a dialog where you can enter a new name for the file. 

Renaming a file will close the file, change the filename, and reopen the file. This allows you to quickly rename files without having to download a copy and rename it locally. This function does not currently handle external file references or other places that reference the file name. 
