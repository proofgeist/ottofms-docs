...
Multiple offsite backup locations and schedules can be configured for each server as of OttoFMS version 4.6.0. This allows you to back up ceratin sets of files to different locations, or with different frequencies.
