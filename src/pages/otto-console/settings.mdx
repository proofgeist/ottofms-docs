...
After entering this information, you can click the "Test" button to verify that OttoFMS can connect to your storage provider. If the test is successful, you can click "Save" to save the configuration. If the test fails, you will be prompted to correct the information and try again.
...
When you trigger a build from [OttoDeploy](/ottodeploy-features/builds) or the [OttoFMS Developer API](/apidoc#tag/Build/operation/PostOttoApiBuild), it is stored on the server. This setting here allows you to choose how many builds you want to keep. The larger the number, the more space it will take up on your server.
