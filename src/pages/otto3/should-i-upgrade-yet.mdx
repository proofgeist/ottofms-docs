...
- **You don't have a valid SSL certificate for your FileMaker Server**. OttoFMS requires a valid SSL certificate for your FileMaker Server. If you don't have one, you will need to get one before you can upgrade to OttoFMS.
