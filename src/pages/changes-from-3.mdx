...
- **You have made major customizations to Migrator.fmp12**. OttoDeploy, the replacement for Migrator.fmp12, is not as customizable as Migrator.fmp12 was. If you're unable to use OttoDeploy for your custom workflow, we welcome all feature requests via the [forum](https://community.proofgeist.com).
