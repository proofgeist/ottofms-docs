...
**Looking for Otto 3 Docs? [click here](https://v3.ottofms.com)**
...
<Cards>
  <Card title="Transition FAQs" arrow href="/getting-started/install" />
  <Card title="Should I Upgrade" arrow href="/otto3/should-i-upgrade-yet" />
  <Card title="How to Upgrade" arrow href="/otto3/how-to-upgrade" />
...
Otto v3 included email based tech support. Since OttoFMS is a free product, free support will be provided via the [community forum](https://community.proofgeist.com) so that our answers to all questions can be public to help others. Paid support is available; learn more on the [support page](/support).
...
- **No more port 3030**. OttoFMS now runs on port 443 along with your FileMaker Server. This means that you no longer need to open up an additional port on your firewall, and you don't have to do anything special to get it to work with SSL.
...
These features are being retired as they are no longer useful or viable:
