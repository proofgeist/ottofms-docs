...
We hope that OttoFMS and its companion apps like OttoDeploy will cover 90% of all the uses cases out there, so you don't have to use the API directly. But if you do, it's there for you.
