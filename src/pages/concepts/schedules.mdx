...
Rather then creating another way to schedule actions on a FileMaker Server, OttoFMS uses FileMaker Server's System Script Schedules feature to trigger the deployment.
