...
OttoDeploy's deployment interface lets you choose a list of other files to close as part of the deployment. This is done in the `Additional Options` section of a deplopment.
