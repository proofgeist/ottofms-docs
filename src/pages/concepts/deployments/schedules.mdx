...
OttoFMS comes with the ability to schedule a [Deployment](/concepts/deployments) to run at a later date and time. This is useful if you want to set up a deployment to run after hours when no one uses the system.
...
In OttoFMS version 4.4.0 or later, you can set up a recurring deployment. See the guide [here](/guides/deployment-patterns/recurring-deployments) for more details.
