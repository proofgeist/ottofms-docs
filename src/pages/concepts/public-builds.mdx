...
Use OttoDeploy to download the build. Unzip the archive and extract the manifest.json file. Leave the archvie intact. You will need it both the manifest.json file and the archive to distribute your build.
