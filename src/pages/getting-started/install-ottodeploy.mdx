...
Follow the instructions above to download the latest version using OttoFMS, and navigate to the FileMaker Server tab of OttoFMS, download the file.
...
This is also why we give you the file to host and manage. You should set up passwords and privileges to protect this file as you see fit.
