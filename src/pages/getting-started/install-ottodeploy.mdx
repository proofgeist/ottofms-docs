...
You only need 1 copy of OttoDeploy to manage multiple installs of OttoFMS. We recommend hosting it on your "development" server for the best experience. This allows you to share access to it with your team and keep it easily upgraded when new versions are released. It will run as a local FileMaker file on your desktop, but you would need to manually migrate your data when a new version is released.
