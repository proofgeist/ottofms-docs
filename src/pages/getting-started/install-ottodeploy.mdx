...
<Callout type="info">
  This method requires that your server can reach out to
  https://downloads.ottomatic.cloud, which is the site we distribute OttoDeploy
  and OttoFMS builds from. If you are using a firewall or other network security
  tools, you may need to add an exception for this domain.
</Callout>
