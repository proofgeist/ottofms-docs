...
<Callout type="info">
  OttoFMS **does** run on Apple Silicon based Macs under Rosetta 2. Even though
  it isn't running natively it is still very fast. We are planning to have an
  Apple Silicon native version in the future.
</Callout>
...
- You have your free [OttoFMS license key](https://ottofms.com)
- You can access the [OttoFMS license server](https://edd-sl-proxy.geistgate.com) using a web browser within your server's network
...
Open your browser and enter https://[host]/otto/, where [host] is the fully qualified domain name of your FileMaker Server machine. This will open up the OttoFMS web console.
