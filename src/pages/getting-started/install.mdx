...
- You can access the [OttoFMS license server](https://edd-sl-proxy.geistgate.com) using a web browser within your server's network. You should get a "Success" message when you visit that [page](https://edd-sl-proxy.geistgate.com).
