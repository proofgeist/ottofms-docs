...
Download for [Linux](https://console.ottomatic.cloud/downloads/ottofms/4.3.3/amd), [Linux (arm)](https://console.ottomatic.cloud/downloads/ottofms/4.3.3/arm), [Windows](https://console.ottomatic.cloud/downloads/ottofms/4.3.3/win), [Mac](https://console.ottomatic.cloud/downloads/ottofms/4.3.3/mac)
...
- the running deployment timer (and the values in the deployment log) will now show times longer than 24 hours.
- copies can now be run on closed files in builds. copies run on closed files run much faster than copies on open files.
- Special characters in filenames are now properly encoded for fmp:// launch urls
...
Download for [Linux](https://console.ottomatic.cloud/downloads/ottofms/4.3.2/amd), [Linux (arm)](https://console.ottomatic.cloud/downloads/ottofms/4.3.2/arm), [Windows](https://console.ottomatic.cloud/downloads/ottofms/4.3.2/win), [Mac](https://console.ottomatic.cloud/downloads/ottofms/4.3.2/mac)
...
Download for [Linux](https://console.ottomatic.cloud/downloads/ottofms/4.3.1/amd), [Linux (arm)](https://console.ottomatic.cloud/downloads/ottofms/4.3.1/arm), [Windows](https://console.ottomatic.cloud/downloads/ottofms/4.3.1/win), [Mac](https://console.ottomatic.cloud/downloads/ottofms/4.3.1/mac)
...
Download for [Linux](https://console.ottomatic.cloud/downloads/ottofms/4.3.0/amd), [Linux (arm)](https://console.ottomatic.cloud/downloads/ottofms/4.3.0/arm), [Windows](https://console.ottomatic.cloud/downloads/ottofms/4.3.0/win), [Mac](https://console.ottomatic.cloud/downloads/ottofms/4.3.0/mac)
