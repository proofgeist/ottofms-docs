...
<Callout type="info">
  OttoFMS Beta Period ends January 1st 2024. <br />
  After this time, beta installs of OttoFMS will no longer function and you will
  need to upgrade to the stable release.
</Callout>

We expect that OttoFMS will reach a final public release by the end of January 2024. Until then, we will be releasing Beta versions of OttoFMS. These versions will be available to all users, but will not be recommended for production use.
