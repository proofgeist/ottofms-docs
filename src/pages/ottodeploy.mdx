import { Callout, Cards, Card, CopyToClipboard } from "nextra/components";
...
A good place to start your investigation of OttoDeploy is to learn about the [main concepts](/concepts). They will provide you with an understanding of how OttoDeploy works with OttoFMS.
