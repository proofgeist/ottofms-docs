...
Transferring large files off of a Windows FileMaker servers with OttoFMS is currently very slow. We are aware of this problem and are working on a solution.
