...
If you upgrade OttoFMS or FileMaker Server or the Mac os operating system, and suddenly migrations stop working with a permission error, it is likely that OttoFMS does not have access to the backup disk.

### OttoFMS does not start.

After installing Otto, you can't reach the OttoFMS web interface. If you check the stderr.log file in Otto's log folder you will see an error like this:
