...
- [ ] Unzip the archive
- [ ] Double click the OttoReceiver.fmaddon file. It will automatically install itself in the proper location.
...
Navigate to the [API Keys page](/otto-console/webhooks) in the web console.
...
Enter a channel. Channels are used to identify the webhook. You can use any string you want. It is a good idea to use a channel that is related to the third party service you want to integrate with.

This value will end up in the Channel field of the OttoReceiverInbox table.

### Add a label (optional)

Labels are just used to make it easier to identify a webhook. You can use any string you want.

### Copy the URL

Copy the URL that is shown in the dialog. You will need this URL to configure your webhook in the third party service you want to integrate with.
...
OttoFMS will then call the OttoReceiver script in your FileMaker file. You can use this script to process the webhook.
