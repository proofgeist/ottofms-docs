...
You will need to turn on the [Advanced Options](/ottodeploy-features/deployments/advanced-options) in the deployment settings to use sub-deployments and the abort remaining sub-deployments features.
